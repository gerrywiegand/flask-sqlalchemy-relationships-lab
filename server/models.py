...
from sqlalchemy.ext.associationproxy import association_proxy  # noqa: F401
...
class Speaker(db.Model):
    ...
    bio = db.relationship(
        "Bio", back_populates="speaker", uselist=False, cascade="all, delete-orphan"
    )
    ...
    events = association_proxy("sessions", "event")
